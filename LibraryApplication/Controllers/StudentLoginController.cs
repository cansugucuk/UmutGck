...
namespace LibraryApplication.Controllers
{
    public class StudentLoginController : Controller
    {
        ...
        public ActionResult Login()
        {
            ...
            return View("~/Views/Login/StudentLogin/StudentLogin.cshtml");
        }
        ...
        public ActionResult Login([Bind(Include = "Username,Password")]Admin model)
        {
            ...
            var user = dbContext.Students.FirstOrDefault(p=>p.Username == model.Username && p.Password == model.Password);
            if (user == null)
            {
